    ...
    <div className="space-y-4">
      ...
      <form onSubmit={handleSubmit} className="relative">
        <input
          ...
          disabled={loading}
          maxLength={500}
          className="w-full px-4 py-3 pr-12 text-sm bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 placeholder:text-gray-400"
        />
        <button
          type="submit"
