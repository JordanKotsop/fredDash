...
export function ChartSkeleton() {
  return (
    <div className="animate-pulse">
      ...
      <div className="h-[300px] bg-gray-100 dark:bg-gray-800 rounded-lg flex items-end justify-between px-8 pb-8 gap-1">
      ...
      <div className="h-3 w-64 bg-gray-200 dark:bg-gray-700 rounded mt-3" />
    </div>
  );
}
